...
# Path for CSV file in PyBankcsv
PyBankcsv = os.path.join("Resource","budget_data.csv")

# Create the lists variables 
profit = []
monthly_changes = []
date = []
...
# Open CSV 
with open(PyBankcsv, newline="") as csvfile: csvreader = csv.reader(csvfile, delimiter=",")
csv_header = next(csvreader

# Conducting the ask
for row in csvreader:    

# Use count for months
count = count + 1 
